const endpointGroups = {
  Auth: [
    ...
    },
    {
      ...
      response: { message: 'Login successful', token: '<jwt>', patient: { id: '', name: '', email: '', age: '', gender: '', phoneNumbers: [], medicalHistories: [], address: { city: '', street: '', gov: '' }, profileImage: '', profileImageUrl: '' } },
    },
    {
      group: 'Auth',
      method: 'GET',
      ...
      auth: true,
      description: "Get the logged-in patient's profile (password excluded)",
      body: null,
      response: { message: 'Profile retrieved successfully', patient: { id: '', name: '', email: '', age: '', gender: '', phoneNumbers: [], medicalHistories: [], address: { city: '', street: '', gov: '' }, profileImage: '', profileImageUrl: '' } },
    },
    {
      group: 'Auth',
      method: 'PUT',
      ...
      response: { message: 'Profile updated successfully', patient: { id: '', name: '', email: '', age: '', gender: '', phoneNumbers: [], medicalHistories: [], address: { city: '', street: '', gov: '' }, profileImage: '', profileImageUrl: '' } },
    },
    {
      group: 'Auth',
      method: 'PUT',
      ...
      auth: true,
      description: 'Change the logged-in patient\'s password by verifying the current password first',
      body: {
    ...
    },
    {
      ...
      auth: true,
      description: 'Upload or replace the logged-in patient\'s profile image',
      body: { type: 'multipart/form-data', fields: { image: 'image file (jpeg/jpg/png/gif/webp, max 5 MB)' } },
      response: { message: 'Profile image uploaded successfully', patient: { id: '', name: '', email: '', age: '', gender: '', phoneNumbers: [], medicalHistories: [], address: { city: '', street: '', gov: '' }, profileImage: '', profileImageUrl: '' } },
    },
    {
      group: 'Auth',
      method: 'GET',
      path: '/api/auth/profile/image',
      auth: true,
      description: 'Download the logged-in patient\'s profile image',
      body: null,
  ...
  Diagnosis: [
    ...
    },
    {
      ...
      auth: true,
      description: 'Retrieve a single diagnosis by ID for the logged-in patient, including the generated medical report',
      body: null,
      response: {
        diagnosis: {
          _id: 'string(ObjectId)',
    ...
    },
    {
      ...
      auth: true,
      description: 'Retrieve all past diagnoses for the logged-in patient with saved input/output image paths',
      body: null,
      response: {
        count: 0,
        diagnoses: [
